...
export function BinaryToHexadecimalAnalysis({ result }: AnalysisProps) {
  const isNegative = result.input.trim().startsWith("-");
  return (
    <Section title="Análisis de entrada">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
        <div>
          <div className="text-muted-foreground">Valor binario</div>
        ...
        <div>
          ...
          <div className="font-mono">Binario (Base 2)</div>
        </div>
        <div>
