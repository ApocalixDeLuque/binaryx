...
export function HexadecimalToDecimalAnalysis({ result }: AnalysisProps) {
  const isNegative = result.input.trim().startsWith("-");
  return (
    <Section title="Análisis de entrada">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
        <div>
          <div className="text-muted-foreground">Valor hexadecimal</div>
        ...
        <div>
          ...
          <div className="font-mono">Hexadecimal (Base 16)</div>
        </div>
        <div>
